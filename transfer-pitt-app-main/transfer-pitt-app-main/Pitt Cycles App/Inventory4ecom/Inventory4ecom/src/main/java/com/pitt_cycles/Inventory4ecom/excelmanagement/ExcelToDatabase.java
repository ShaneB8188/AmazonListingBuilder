    ...
    public void parseAndUploadExcel(File file) throws Exception {
        try (FileInputStream fis = new FileInputStream(file);
            ...
            for (Row row : sheet) {
                ...
                String sql = "INSERT INTO indian_inv (asin, sku, mpn, auction_title, gtin, brand, reporting_brand, parent_sku, msrp_usd, isnew,msrp_can, avail_can, ebay_listing_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?)";
                ...
                try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
                    ...
                    preparedStatement.setString(11,ebay_listing_id);
                    preparedStatement.setString(12,msrp_can );
                    preparedStatement.setString(13, availCan);
